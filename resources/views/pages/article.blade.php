            ...
            <article class="row format-standard">
                ...
                <div class="s-content__header col-full">
                    ...
                    <ul class="s-content__header-meta">
                        <li class="date">{{ $article->created_at->format('d-m-Y') }}</li>
                        <li class="cat">
                            Категория
                            <a href="{{asset( \App\Models\Category::$routePrefix .  $article->category->slug )}}">
                    ...
                    <div class="s-content__author">
                        ...
                        <div class="s-content__author-about">
                            <h4 class="s-content__author-name">
                                <a href="#0">{{ $article->author->name }}</a>
                            </h4>
                        ...
                        <div class="s-content__nav">
                            @if ($article->prevArticle)
                                <div class="s-content__prev">
                                    <a href="{{ asset( \App\Models\Article::$routePrefix . $article->prevArticle->slug) }}"
                                       rel="prev">
                            ...
                            @if ($article->nextArticle)
                                <div class="s-content__next">
                                    <a href="{{ asset(\App\Models\Article::$routePrefix . $article->nextArticle->slug) }}"
                                       rel="next">
                                            ...
                                            <li class="depth-3 comment">
                                                ...
                                                <div class="comment__avatar">
                                                    <img width="50" height="50" class="avatar"
                                                         src="images/avatars/user-04.jpg" alt="">
                                                </div>
