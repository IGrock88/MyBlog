    ...
    <div class="col-full">
        ...
        <div class="featured">
                ...
                <div class="entry" style="background-image:url({{asset('uploads/' . $mostPopular->titleImage)}});">
                    ...
                    <div class="entry__content">
                        <span class="entry__category">
                            <a href="{{ asset($mostPopular->category->slug) }}">{{$mostPopular->category->name}}</a>
                        </span>
            ...
            <div class="featured__column featured__column--small">
                ...
                <div class="entry" style="background-image:url({{asset('uploads/' . $article->titleImage)}});">

                    <div class="entry__content">
                        <span class="entry__category"><a href="{{ asset($article->category->slug) }}">{{$article->category->name}}</a></span>
